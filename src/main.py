...
def run(
    ...
    models_names : list of str, default=["etc"]
        Names of the models following project usage. See README.md for more information.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        help="""
             Choose the number of gridsearch trials.
             Default: 25.
             """
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="""
             Use this option to activate submitting a file.
             Default: Activated.
             """
    )
    parser.add_argument(
        ...
        dest="trial",
        help="""
             Use this option to deactivate submitting a file.
             Default: Activated.
             """
    )
